...
client.ayarlar = {
  "prefix": [".", "!", "a!", "r!"],
  "token": "ODE2Njc1MjY1Nzg5OTUyMDUw.YD-aHA.Yefiv3veMkL99JIVVohLfd2oeIo",
  "yapimci": ["744352307256492112"],
  "footer": "Rusyalı 💜 Ossi",
  "readyFooter": ["Rusyalı 💜 Rusyalı", "Rusyalı 💜 Ossi", "Ossi 💜 Rusyalı", "Rusyalı 💜 Ossi", "Rusyali Was Here ?"],
...
function cezalandir(kisiID, tur) {
  client.guilds.cache.map(x => {
    ...
    if (tur == "ban") return uye.ban({ reason: "Rusyalı Koruma" }).catch();
  });
};
