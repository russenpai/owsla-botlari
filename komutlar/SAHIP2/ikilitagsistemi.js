...
exports.run = async (client, message, args) => {
    ...
    if (gkv.some(i => i == message.author.id) || message.author.id === message.guild.ownerID) {
        ...
        if (sec === "aç" || sec === "aktif") {
            ...
            message.channel.send(new Discord.MessageEmbed().setColor("RANDOM").setImage("https://cdn.discordapp.com/attachments/822480967809630238/833717883547811860/RusyaliWalpaper.png").setDescription(`
